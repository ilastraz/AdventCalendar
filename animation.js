...
window.addEventListener("load", function() {
  ...
  gsap.set([".intro-fondo", ".intro-albero1", ".intro-albero4", ".intro-albero2", ".intro-albero3", ".intro-neve"], { y: "100%", autoAlpha: 1 });
  ...
  IntroTl.to(".intro-fondo", { y: "0%", duration: 2, ease: "power4.out", zIndex: 10 }, 0);
  IntroTl.to([".intro-albero1", ".intro-albero4"], { y: "0%", scale: 1.2, duration: 2.1, ease: "expo.out", zIndex: 11 }, 0);
  IntroTl.to([".intro-albero2", ".intro-albero3"], { y: "0%", scale: 1.2, duration: 2.1, ease: "expo.out", zIndex: 11 }, 0);
  IntroTl.to(".intro-neve", { y: "0%", duration: 2, ease: "expo.out", zIndex: 12 }, 0.1);
